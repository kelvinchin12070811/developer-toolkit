...
import { FaClock, FaQrcode } from 'react-icons/fa6';
...
export function DrawerContent() {
  return (
    <>
      ...
      <MenuItem to='/generators/barcode'>{renderMenuIcon(FaQrcode, 20)} Barcode</MenuItem>
      <MenuItem to='/generators/characters'>
        {renderMenuIcon(TbAlphabetLatin, 26)} Characters
      </MenuItem>
